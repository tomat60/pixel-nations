...
const steps = [
  ...
  { id: "12-retention-state-after-reload", label: "Retention state after reload", note: "Reload preserves completed first era, city institutions, frontier objective, and world consequence markers.", run: async (page) => {
    await page.reload({ waitUntil: "domcontentloaded", timeout: 10000 });
    await page.waitForLoadState("networkidle", { timeout: 5000 }).catch(() => {});
    await clickDock(page, "council");
