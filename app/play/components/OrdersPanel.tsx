import { developmentOrders, getPhase, type PlayAction, type PlayState } from "../lib/play-state";
...
export function OrdersPanel({ state, dispatch }: { state: PlayState; dispatch: (action: PlayAction) => void }) {
  ...
  return (
    <aside data-qa="orders-panel" className="absolute right-3 top-[12rem] z-20 max-h-[calc(100%-18rem)] w-[300px] overflow-hidden rounded-3xl border border-amber-100/20 bg-black/58 p-3 shadow-2xl backdrop-blur-md md:right-5 md:top-[11.8rem] md:w-[390px] md:p-4">
      ...
      <div className="mt-3 max-h-[260px] space-y-2 overflow-auto pr-1 md:max-h-[330px]">
