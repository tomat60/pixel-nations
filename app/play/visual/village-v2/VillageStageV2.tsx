...
const APPROVED_SCENE_SOURCE =
  "https://raw.githubusercontent.com/tomat60/pixel-nations/26c47df71c6f9b1f9f91e17759c03483a2e10b7f/docs/visual-evidence/village-v2-approved-direction.webp";
...
export function VillageStageV2({ state }: { state: PlayState }) {
  ...
  return (
    <div
      ...
      data-visual-source-sha="26c47df71c6f9b1f9f91e17759c03483a2e10b7f"
      className="relative h-full w-full overflow-hidden bg-[#171810]"
    >
      <div className="absolute inset-0 overflow-hidden">
        <img
          src={APPROVED_SCENE_SOURCE}
          alt=""
          draggable={false}
          loading="eager"
          decoding="sync"
      ...
      {visibleLayers.map((layer, index) => (
        ...
        >
          ...
          />
          <span data-qa={QA_MARKERS[layer.id]} className="absolute left-1 top-1 h-px w-px" />
        </div>
      ))}
