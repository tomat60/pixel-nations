...
func _initialize() -> void:
	...
	_check(String(core_session.get("contract", "")) == "AURELIAN_DEFAULT_FIRST_SESSION_V6", "core_session_contract")
...
func _finish() -> void:
	if failures.is_empty():
		print("AURELIAN_DEFAULT_FIRST_SESSION_V6_TEST: PASS")
		quit(0)
		return
	for failure in failures:
		push_error("AURELIAN_DEFAULT_FIRST_SESSION_V6_TEST_FAILURE: %s" % failure)
	print("AURELIAN_DEFAULT_FIRST_SESSION_V6_TEST: FAIL (%d)" % failures.size())
	quit(1)
