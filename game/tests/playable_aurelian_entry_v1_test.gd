...
func _initialize() -> void:
	...
	_check(backward_path.has("map_east_route_claimed"), "backward_claimed_map")
	_check(backward_path.has("world_trade_selected"), "backward_world")
	...
	_check(controller.contains("SESSION.save_session(entry_state, restored_intent, SESSION.NATIVE_PATH, settlement_founded, settlement_developed)"), "saves_session")
