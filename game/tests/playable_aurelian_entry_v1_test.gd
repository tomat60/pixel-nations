...
func _initialize() -> void:
	...
	_check(manifest.get("forward_path", []) == ["world_neutral", "world_trade_selected", "map_east_route_selected", "map_east_route_claimed", "village_claimed"], "forward_path")
	_check(manifest.get("backward_path", []) == ["village_claimed", "map_east_route_claimed", "world_trade_selected"], "backward_path")
